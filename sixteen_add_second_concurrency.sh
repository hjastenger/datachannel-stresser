...
echo "done starting application, starting stress session"
# Reliable WS
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket_ping --messages=480 --interval=250 --concurrent=10 --optional=SixteenthRoundReliableWS --protocol=websocket --repeat=15
...
echo "done starting application, starting stress session"
# Reliable DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --concurrent=10 --ordered=true --optional=SixteenthRoundReliableDC --protocol=datachannel --repeat=15
...
echo "done starting application, starting stress session"
# Reliable DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --concurrent=10 --ordered=false --optional=SixteenthRoundReliableDC --protocol=datachannel --repeat=15
...
# Unreliable RTX Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-times=0 --concurrent=10 --optional=SixteenthRoundUnreliableDC --protocol=datachannel --repeat=15

rebootServer
startApplication

# Unreliable RTO Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-timeout=1 --concurrent=10 --optional=SixteenthRoundUnreliableDC --protocol=datachannel --repeat=15
...
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket_ping --messages=480 --interval=250 --concurrent=10 --optional=SixteenthRoundReliableWS2.5% --protocol=websocket --repeat=15

rebootServer
startApplication
setPacketLoss 2.5%

node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --concurrent=10 --optional=SixteenthRoundReliableDC2.5 --protocol=datachannel --repeat=15
...
# Unreliable RTO Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=true --concurrent=10 --optional=SixteenthRoundReliableDC2.5 --protocol=datachannel --repeat=15

rebootServer
startApplication
setPacketLoss 2.5%

node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-times=0 --concurrent=10 --optional=SixteenthRoundUnreliableDC2.5 --protocol=datachannel --repeat=15
...
# Unreliable RTX Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-times=1 --concurrent=10 --optional=SixteenthRoundUnreliableDC2.5 --protocol=datachannel --repeat=15
...
# Unreliable RTX Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-times=2 --concurrent=10 --optional=SixteenthRoundUnreliableDC2.5 --protocol=datachannel --repeat=15
...
# Unreliable RTO Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-timeout=1 --concurrent=10 --optional=SixteenthRoundUnreliableDC2.5 --protocol=datachannel --repeat=15
...
# Unreliable RTO Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-timeout=500 --concurrent=10 --optional=SixteenthRoundUnreliableDC2.5 --protocol=datachannel --repeat=15
...
# Unreliable RTO Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-timeout=1000 --concurrent=10 --optional=SixteenthRoundUnreliableDC2.5 --protocol=datachannel --repeat=15
...
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket_ping --messages=480 --interval=250 --concurrent=10 --optional=SixteenthRoundReliableWS5.0% --protocol=websocket --repeat=15
...
# Unreliable RTX Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --concurrent=10 --optional=SixteenthRoundReliableDC5.0 --protocol=datachannel --repeat=15
...
# Unreliable RTX Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=true  --concurrent=10 --optional=SixteenthRoundReliableDC5.0 --protocol=datachannel --repeat=15
...
# Unreliable RTX Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-times=0 --concurrent=10 --optional=SixteenthRoundUnreliableDC5.0 --protocol=datachannel --repeat=15
...
# Unreliable RTX Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-times=1 --concurrent=10 --optional=SixteenthRoundUnreliableDC5.0 --protocol=datachannel --repeat=15
...
# Unreliable RTX Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-times=2 --concurrent=10 --optional=SixteenthRoundUnreliableDC5.0 --protocol=datachannel --repeat=15
...
# Unreliable RTO Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-timeout=1 --concurrent=10 --optional=SixteenthRoundUnreliableDC5.0 --protocol=datachannel --repeat=15
...
# Unreliable RTO Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-timeout=500 --concurrent=10 --optional=SixteenthRoundUnreliableDC5.0 --protocol=datachannel --repeat=15
...
# Unreliable RTO Unordered DC
node index.js -u http://10.133.58.193:9000/empty -w ws://10.133.58.193:9000/websocket --messages=480 --interval=250 --ordered=false  --retransmit-timeout=1000 --concurrent=10 --optional=SixteenthRoundUnreliableDC5.0 --protocol=datachannel --repeat=15
